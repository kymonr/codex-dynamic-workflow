...
- After that single first check, ordinary proactive polling returns to the 5 minutes / 300 second minimum heartbeat unless the current user explicitly asks for status/stop/immediate handling.
