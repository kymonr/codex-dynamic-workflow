...
Worktree Writer v2 is a separate explicit mode governed by [worktree-writer-usage.md](worktree-writer-usage.md) and [worktree-writer-v2.md](worktree-writer-v2.md). Package v1 remains bounded-Luna input compatibility only; the v1 contract is historical.
