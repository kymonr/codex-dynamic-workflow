...
Attack cases: min-three barrier; hidden required work; slot starvation; unspent Astra budget stolen; snapshot/live source collision; optional failures relabeled; claims hidden by retry; stale dismissals; old completed work reused as promotion; late claims ignored; v3 version lockout; validator disabled by major-version bump. These are covered by targeted negative tests and source review.
