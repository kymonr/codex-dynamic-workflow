...
Team Router is the repository root project. This subfolder keeps the legacy dynamic-workflow / cli-runner code, docs, skill, and tests. For Team Router usage, see the root `README.md`, `skills/codex-team-router/`, and `docs/runbooks/codex-team-router-live-orchestration.md`.
## 运行环境结论（任务 1 探针填写）
